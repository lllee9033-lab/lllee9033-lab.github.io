...
const list = [
	...
	},
	{
		...
		label: '我的 GitHub',
		href: 'https://github.com/lllee9033-lab'
	}
]
			...
			<HomeDraggableLayer cardKey='navCard' x={position.x} y={position.y} width={styles.width} height={styles.height}>
				<Card
					...
					<Link className='flex items-center gap-3' href='/'>
						<div className='relative h-10 w-10 shrink-0 overflow-hidden rounded-full' style={{ boxShadow: '0 12px 20px -5px #E2D9CE' }}>
							<Image src='/images/avatar.png' alt='Lllee 的头像' fill sizes='40px' className='object-cover object-[60%_35%]' />
						</div>
					...
					{(form === 'full' || form === 'icons') && (
						<>
							{form !== 'icons' && <div className='text-secondary mt-6 text-sm'>充当文艺青年</div>}
